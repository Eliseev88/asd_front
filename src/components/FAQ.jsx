  ...
  return (
	<section className='faq' id='faq'>
		...
		<div className="faq__wrp">
			...
			<div className="faq__answer">
				{t('Мы')}&nbsp;{t('принимаем оплату криптовалютой и банковскими картами. Напишите нам, мы')}&nbsp;{t('поможем разобраться, если нужна помощь')}.
			</div>
		</div>
		<div className="faq__wrp">
		...
		<div className="faq__wrp">
			...
			<div className="faq__answer">
				{t('Да, в')}&nbsp;{t('течение')} 48&nbsp;{t('часов после оплаты вы')}&nbsp;{t('можете запросить полный возврат средств')},<br></br> 
