    ...
    <>
      ...
      <div className='mobile-tariffs__block'>
        ...
        <div className="mobile-tariffs__wrp">
          <div className='mobile-tariffs__name'>{t('Тариф')} <span className='tariffs__name--var1'>DE1</span></div>
          <div>
      ...
      <div className='mobile-tariffs__block'>
        ...
        <div className="mobile-tariffs__wrp">
          <div className='mobile-tariffs__name'>{t('Тариф')} <span className='tariffs__name--var2'>DE2</span></div>
          <div>
            <div className="mobile-tariffs__price">
              <div className='mobile-tariffs__month'>{t(declension('%d %s', 1, ['месяц', 'месяца', 'месяцев']))}</div>
              <div className='mobile-tariffs__cost'>
      ...
      <div className='mobile-tariffs__block'>
        ...
        <div className="mobile-tariffs__wrp">
          <div className='mobile-tariffs__name'>{t('Тариф')} <span className='tariffs__name--var3'>DE3</span></div>
          <div>
            <div className="mobile-tariffs__price">
              <div className='mobile-tariffs__month'>{t(declension('%d %s', 1, ['месяц', 'месяца', 'месяцев']))}</div>
              <div className='mobile-tariffs__cost'>
      ...
      <div className='mobile-tariffs__block'>
        ...
        <div className="mobile-tariffs__wrp">
          <div className='mobile-tariffs__name'>{t('Тариф')} <span className='tariffs__name--var4'>DE4</span></div>
          <div>
            <div className="mobile-tariffs__price">
              <div className='mobile-tariffs__month'>{t(declension('%d %s', 1, ['месяц', 'месяца', 'месяцев']))}</div>
              <div className='mobile-tariffs__cost'>
      ...
      <div className='mobile-tariffs__block'>
        ...
        <div className="mobile-tariffs__wrp">
          <div className='mobile-tariffs__name'>{t('Тариф')} <span className='tariffs__name--var5'>DE5</span></div>
          <div>
            <div className="mobile-tariffs__price">
              <div className='mobile-tariffs__month'>{t(declension('%d %s', 1, ['месяц', 'месяца', 'месяцев']))}</div>
              <div className='mobile-tariffs__cost'>
